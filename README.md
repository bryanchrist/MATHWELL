...
Our datasets, model and code are released under the MIT license. MATHWELL falls under the Llama-2 license and requires access to the 70B model weights through a HuggingFace access token. 
