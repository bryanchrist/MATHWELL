...
[Paper](https://arxiv.org/abs/2402.15861) | [Model Weights](https://huggingface.co/bryanchrist/MATHWELL) | [EGSM Dataset](https://huggingface.co/datasets/bryanchrist/EGSM) | [Human Annotation Dataset](https://huggingface.co/datasets/bryanchrist/annotations)

This codebase is based off the paper MATHWELL: Generating Educational Math Word Problems at Scale, and includes code for interacting with the MATHWELL model and EGSM dataset. 
...
# Loading EGSM and the Human Annotation Dataset 
You can load our datasets using the following code: 
```python
from datasets import load_dataset
egsm = load_dataset('bryanchrist/egsm')
...
@inproceedings{christ_bryan_r_mathwell_2024,
	title = {{MATHWELL}: {Generating} {Educational} {Math} {Word} {Problems}},
