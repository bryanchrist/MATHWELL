...
This codebase is based off the paper MATHWELL: Generating Educational Math Word Problems Using Teacher Annotations, and includes code for interacting with the MATHWELL model and EGSM dataset. 
