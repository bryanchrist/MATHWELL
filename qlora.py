# This code comes from the QLoRA repository (https://github.com/artidoro/qlora), with minor adaptations (loading huggingface token and fixing 
# an issue with the embedding dimensions). 
